    ...
    <>
      ...
      <Modal show={isOpen} onHide={onClose} animation={true} centered>
        ...
        <Modal.Body className="text-uppercase">
          ...
          <hr />
          <p className="d-flex justify-content-between" onClick={() => changeLanguage("de")}>
          ...
          <hr />
          <p className="d-flex justify-content-between" onClick={() => changeLanguage("zh")}>
          ...
          <hr />
          <p className="d-flex justify-content-between" onClick={() => changeLanguage("fr")}>
