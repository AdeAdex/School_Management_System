      ...
      axios.post(endpoint, values).then((res) => {
        if (res.data.status) {
          ...
          if (res.data.errorMessage) {
            ...
            setMessage("If you haven't made the payment for admission yet, you won't have a valid Student ID. Please make the payment by login to Admission portal to receive your Student ID. Thanks")
          } else {
            const Toast = Swal.mixin({
              toast: true,
              position: "top",
