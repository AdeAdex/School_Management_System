  ...
  return (
    <>
        ...
        <form className='d-flex flex-column gap-4'>
          ...
          <textarea id="message" name="message" required="" placeholder="MESSAGE" className="text-capitalize border-0  py-2 px-3" style={{backgroundColor: '#F9F9F9', height: '8.5em', resize: 'none'}}></textarea>
          <div className='w-100 justify-content-end d-flex'>
          <button type="submit" className='submit-btn btn btn-sm py-2 skyblue col-3 text-white text-uppercase'>send</button>
          </div>
        </form>
      </div>
    </>
