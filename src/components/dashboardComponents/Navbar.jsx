    ...
    <>
      ...
      >
        ...
        <div className="w-50 my-auto flex justify-end gap-5 mr-7">
                <button onClick={gooo} className=""><i className="fas fa-bell fs-4 my-auto"></i></button>
                <button onClick={gooo} className=""><i className="fas fa-user fs-4 my-auto"></i></button>
                <button onClick={gooo} className=""><i className="fas fa-envelope fs-4 my-auto"></i></button>
                <button onClick={gooo} className=""><i className="fas fa-gear fs-4 my-auto"></i></button>
                <button onClick={gooo} className=""><img src="pic/avatar.png" style={{width: '50px'}} alt="" /></button>
        </div>
      </div>
