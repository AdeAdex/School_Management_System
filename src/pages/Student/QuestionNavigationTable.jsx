...
<div className="question-navigation-table">
  ...
  <ul className="question-number-list">
    {Array.from({ length: totalQuestions }, (_, index) => (
      ...
      >
        <span className={`question-number ${answeredQuestions.includes(index + 1) && window.innerWidth <= 768 ? 'green' : ''}`}>
          {index + 1}
        </span>
        {answeredQuestions.includes(index + 1) && window.innerWidth > 768 && (
          <span className="tick-mark answered" style={{ position: 'absolute', right: 40 }}>
            &#10004;
          </span>
        )}
      </li>
